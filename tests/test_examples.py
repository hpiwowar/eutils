...
import EUtils
from EUtils import ThinClient, HistoryClient, DBIdsClient, Datatypes
import support_test

picklestore = None
PICKLESTORE_FILENAME = "test_examples.pickle"

# Adding for use by nosy
#import os
#picklestore = support_test.UsePickleStore(os.path.join("tests", PICKLESTORE_FILENAME))
...
class TestEUtilsESearchExamples(unittest.TestCase):
    def setup(self):
        ...
        # To run live data:
        eutils = support_test.NoPickleStore().client()
