...
#  .+ 
class QueryTranslation(EUtils.POM.ElementNode):
	CONTENTMODEL = EUtils.POM.ContentModel(('', [('#PCDATA', '')], ''))
...
class eSearchResult(EUtils.POM.ElementNode):
	CONTENTMODEL = EUtils.POM.ContentModel((u',', [(u'|', [(u',', [(u'Count', ''), (u',', [(u'RetMax', ''), (u'RetStart', ''), (u'QueryKey', u'?'), (u'WebEnv', u'?'), (u'IdList', ''), (u'TranslationSet', ''), (u'TranslationStack', u'?'), (u'QueryTranslation', '')], u'?')], ''), (u'ERROR', '')], ''), (u'ErrorList', u'?'), (u'WarningList', u'?')], ''))
